function oxy_out=run_fluct_optim_uptake(rate,time,Vfrac,Tfrac,Sfrac,exp_oxy)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  tiss_pathOut=['tissue_fluctuations/data_V',num2str(Vfrac),...
       '_T',num2str(Tfrac),'_S',num2str(Sfrac),'/Data_uptake'];  
...
% ----- main loop ----- %  
  ...
  while (iter<Niter)
    ...
    vess_oxy =1*oxy_max*ones(Nvess,1); 
    oxy_upTum=rate*oxy_upTum0;        
