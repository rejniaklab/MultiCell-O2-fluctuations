function script_black_influx

oxy_init=load('Exp_data/black_exp.txt');
...
tissueOut=['tiss_fluc_black'];% dir to save fluctuations


  file_to_save=['data_black_influx.txt'];
...
for ii=1:Nfiles
  ...
  [r2,norm2]=oxy_tissue_fluc_black_script(Vfrac,Tfrac,Sfrac,tissueIn,...
             tissueOut,1);
