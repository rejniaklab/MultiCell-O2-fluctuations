function script_magenta_uptake

oxy_init=load('Exp_data/magenta_exp.txt');
...
tissueOut=['tiss_fluc_magenta'];% dir to save fluctuations


file_to_save=['data_magenta_uptake.txt'];
...
for ii=1:Nfiles
  ...
  [r2,norm2]=oxy_tissue_fluc_magenta_script(Vfrac,Tfrac,Sfrac,tissueIn,...
             tissueOut,2);
