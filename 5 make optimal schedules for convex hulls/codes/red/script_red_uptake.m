function script_red_uptake

oxy_init=load('Exp_data/red_exp.txt');
...
tissueOut=['tiss_fluc_red'];% dir to save fluctuations


file_to_save=['data_red_uptake.txt'];
...
for ii=1:Nfiles
  ...
  [r2,norm2]=oxy_tissue_fluc_red_script(Vfrac,Tfrac,Sfrac,tissueIn,...
             tissueOut,2);
