function [r2,norm_res]=oxy_tissue_fluc_red_script(Vfrac,Tfrac,Sfrac,tiss_pathIn,...
...
%~~~~~~~~~~~~~
exp_oxy=load('Exp_data/red_exp.txt');

if case_fluct==1
  influx=load(['Opt_data/red/rateInflux_opt_influx.txt']);
  uptake=load(['Opt_data/red/rateUptake_opt_influx.txt']);
elseif case_fluct==2
  influx=load(['Opt_data/red/rateInflux_opt_uptake.txt']);
  uptake=load(['Opt_data/red/rateUptake_opt_uptake.txt']);
else
  influx=load(['Opt_data/red/rateInflux_opt_both.txt']);
  uptake=load(['Opt_data/red/rateUptake_opt_both.txt']);
end
%~~~~~~~~~~~~
